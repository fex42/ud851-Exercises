...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String savedLifecycleCallbacksText = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            if (savedLifecycleCallbacksText != null) {
                mLifecycleDisplay.setText(savedLifecycleCallbacksText);
            }
        }
